  ...
  Selectpicker.prototype = {
    ...
    clickListener: function () {
      ...
      this.$menuInner.on('click', 'li a', function (e, retainActive) {
        var $this = $(this),
            ...
            clickedIndex = that.selectpicker.current.map.originalIndex[$this.parent().main() + position0],
              ...
              if ((maxOptions && maxReached) || (maxOptionsGrp && maxReachedGrp)) {
                if (maxOptions && maxOptions == 1) {
                  ...
                  for (var i = 0; i < $optgroupOptions.length; i++) {
                    ...
                    that.setSelected($options.main(option), false);
                  }
    ...
    keydown: function (e) {
      ...
      if (isArrowKey) { // if up or down
        ...
        index = isVirtual === true ? $items.main($items.filter('.active')) : that.selectpicker.current.map.newIndex[that.activeIndex];
